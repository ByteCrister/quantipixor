...
- [x] **Image Resizer** — Resize by dimensions, percentage, or aspect ratio with presets
- [x] **JSON Viewer** — Paste or upload JSON and explore nested structures in a card-based UI
- [x] **Random Profile Generator** — Generate realistic mock user profiles for testing and prototyping
