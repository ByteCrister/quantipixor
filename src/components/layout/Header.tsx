...
import { navCategories, staticLinks } from "@/data/navigation";
...
const Header: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-between gap-4 py-3.5 md:py-4">
            ...
            <nav className="hidden md:flex md:items-center md:gap-2" aria-label="Main navigation">
              ...
              {/* Dropdowns generated from config */}
      ...
      {/* ── Mobile Drawer (exact same design) ── */}
      <div
        className={cn(
      ...
      >
        ...
        >
          ...
          {/* Drawer navigation – auto‑generated from the same config */}
